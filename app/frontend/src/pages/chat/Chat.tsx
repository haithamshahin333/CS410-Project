...
import Azure from "../../assets/uiuc.png";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Azure Tech Assistant</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot is configured to answer your questions about Azure technology and answer with enterprise requirements</h2>
                            </Stack>
                        ) : (
